          ...
          <div className="bg-card w-full max-w-md rounded-2xl border border-border shadow-2xl p-6 max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-2 text-sm text-gray-300 mb-4">
              {[
                ...
                ["Payroll Rate", selected.payrollRate != null ? Number(selected.payrollRate).toLocaleString("id-ID") : null],
                ["Salary", selected.salary != null ? Number(selected.salary).toLocaleString("id-ID") : null],
                ["Bio", selected.bio],
