  ...
  return (
    <>
      <div className="mb-6 flex gap-4">
        <div className="tab-btn active cursor-pointer bg-card px-6 py-4 rounded-xl border border-sweat text-sweat font-bold w-1/4 text-center hover:bg-white/5">
          <i className="fas fa-users mb-2 block text-2xl" aria-hidden />
          Member Attendance
        </div>
        <div className="tab-btn cursor-pointer bg-card px-6 py-4 rounded-xl border border-border text-gray-400 font-bold w-1/4 text-center hover:bg-white/5 hover:text-white">
